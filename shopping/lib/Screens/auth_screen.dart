  ...
  void _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage = 'The email you entered is Invalid.Try valid email';
      } else if (error.message.contains('EMAIL_NOT_FOUND')) {
        errorMessage = 'This email does not Exists ';
      } else if (error.message.contains('WEAK_PASSWORD')) {
        errorMessage =
            'Try alphanumeric passwordbecause your password is weak ';
      } else if (error.message.contains('IVALID_PASSWORD')) {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                FlatButton(
                  child: Text(
                      '${_authMode == AuthMode.Login ? 'SIGNUP' : _authMode == AuthMode.ResetPassword ? 'LOGIN' : 'LOGIN'} INSTEAD'),
